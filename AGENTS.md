...
Rust v0.11.1 (crates.io) · Python v0.5.0 (PyPI)
...
| CLI backends (Rust only) | `sdks/rust/src/providers/claude_code/` (feature `claude-code`), `sdks/rust/src/providers/codex_cli/` (feature `codex-cli`) |
